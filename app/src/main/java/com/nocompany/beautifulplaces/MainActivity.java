...
/* TODO
    1. Добавить места (поправить Place)
    2. Дописать адаптер (поправить MyPagerAdapter)
    3. Добавить адаптер в MainActivity
...
public class MainActivity extends AppCompatActivity {
    ...
    public void fabClicked(View view) {
        ...
        String place = places.get(pos).getPlace();

        Snackbar.make(view,"Путешествие заказано: " + place,Snackbar.LENGTH_LONG).show();
